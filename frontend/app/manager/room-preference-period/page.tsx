            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-6">
                ...
                <select
                  ...
                  className="w-full md:w-48 px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
