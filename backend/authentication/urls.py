...
from .views import SignupAPIView, VerifyOTPAPIView, LoginAPIView,UserDetailView, PasswordResetConfirmAPIView, RequestPasswordResetAPIView, StudentDataEntryView
