...
class StudentDataEntry(models.Model):
    ...
    application_form = models.FileField(upload_to='students_documents/', null=True, blank=True)
    hostel_no_dues = models.FileField(upload_to='students_documents/', null=True, blank=True)
    mess_no_dues = models.FileField(upload_to='students_documents/', null=True, blank=True)
    address_proof = models.FileField(upload_to='student_documents/', null=True, blank=True)
    caste_validity_certificate = models.FileField(upload_to='student_documents/', null=True, blank=True)
    income_certificate = models.FileField(upload_to='student_documents/', null=True, blank=True)
    caste_certificate = models.FileField(upload_to='student_documents/', null=True, blank=True)
    ews_certificate = models.FileField(upload_to='student_documents/', null=True, blank=True)
    pwd_certificate = models.FileField(upload_to='student_documents/', null=True, blank=True)
    admission_confirmation_letter = models.FileField(upload_to='student_documents/', null=True, blank=True)
    college_fee_receipt = models.FileField(upload_to='student_documents/', null=True, blank=True)
    non_creamy_layer_certificate = models.FileField(upload_to='student_documents/', null=True, blank=True)
    backlogs = models.IntegerField(null=False,default=0)
    verified = models.BooleanField(null=True, default=None)
    selected = models.BooleanField(default=False)
    seat_alloted = models.CharField(max_length=15, null=True, blank=True)
